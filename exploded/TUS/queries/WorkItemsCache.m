...
let
    ...
    EmptyCache = #table({"AsFoundCheck", "AsFoundResult", "AsLeftCheck", "AsLeftResult", "AssetCompanyId", "AssetCompanyName", "AssetDescription", "AssetId", "AssetName", "AssetOwnership", "AssetSiteId", "AssetSiteName", "AssetTag", "CertificateNumber", "ChannelCount", "CheckedById", "CheckedByName", "CheckedOn", "ClientCompanyId", "CompletedById", "CompletedByName", "CompletedOn", "CreatedOnUtc", "CustomOrderNumber", "DocumentNumber", "DocumentSection", "DueDate", "IsLimited", "ItemAsFoundResult", "ItemAsLeftResult", "ItemResultStatus", "MaintenancePlan", "MaintenanceTask", "NextServiceDate", "NextServiceLevel", "OrderItemNumber", "OverridePartsTotal", "OverrideRepairsTotal", "OverrideServiceTotal", "PartsTotal", "PartsTotalBeforeDiscount", "ProviderCompany", "ProviderPhone", "ProviderTechnician", "RepairsTotal", "ResultStatus", "SerialNumber", "ServiceCharge", "ServiceComments", "ServiceDate", "ServiceLevel", "ServiceLevelDocumentNumber", "ServiceNotes", "ServiceOptions", "ServiceOrderId", "ServiceTotal", "ServiceType", "UpdatedBy", "UpdatedById", "UpdatedOnUtc", "VendorCompanyId", "WorkItemId", "WorkStatus"}, {}),
