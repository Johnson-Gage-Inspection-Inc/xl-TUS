let
    ...
    FreshData = try 
        let
            ...
            #"Changed Type" = Table.TransformColumnTypes(Table1_Table,{{"AssetId", Int64.Type}, {"ClientCompanyId", Int64.Type}, {"Furnace", type any}, {"FormNumber", type text}, {"CalibrationMethod", type text}, {"ToleranceSource", type text}, {"Item", type text}, {"ModelNumber", type any}, {"SerialNumber", type any}, {"UnitNumber", type any}, {"Class", type any}, {"Range", type text}, {"Tolerance", type text}, {"HeatingMethod", type text}, {"WorkingZoneSize", type text}, {"CubicFeet", type any}, {"CalInterval", type any}, {"ControllerId", type any}, {"Controller", type any}, {"ContSN", type any}, {"ContTol", type any}, {"RecorderId", type any}, {"Recorder", type any}, {"RecSN", type any}, {"RecTol", type any}, {"FurnaceSpecificComments", type text}, {"TestLocation", type text}, {"OvenLocation", type text}, {"Condition", type text}, {"PB", type any}, {"Integral", type any}, {"Derivative", type any}, {"Other1", type any}, {"Other2", type any}, {"CheckRec", type any}, {"Load", type text}, {"LagLimit", type number}, {"RecoveryLimit", type number}}),
            #"Clean" = Table.ReplaceErrorValues(#"Changed Type", {{"ModelNumber", null}, {"SerialNumber", null}, {"Class", null}, {"Tolerance", null}, {"CubicFeet", null}, {"CalInterval", null}, {"ControllerId", null}, {"Controller", null}, {"ContSN", null}, {"ContTol", null}, {"RecorderId", null}, {"Recorder", null}, {"RecSN", null}, {"RecTol", null}, {"TestLocation", null}, {"PB", null}, {"Derivative", null}, {"Integral", null}, {"Other1", null}, {"Other2", null}, {"CheckRec", null}}),
    ...
    FinalData = if FreshData <> null then FreshData 
                    ...
                    {"AssetId", "ClientCompanyId", "Furnace", "AddressLine1", "AddressLine2", "AddressLine3", "FormNumber", "CalibrationMethod", "ToleranceSource", "Item", "ModelNumber", "SerialNumber", "UnitNumber", "Class", "Range", "Tolerance", "HeatingMethod", "WorkingZoneSize", "CubicFeet", "CalInterval", "ControllerId", "Controller", "ContSN", "ContTol", "RecorderId", "Recorder", "RecSN", "RecTol", "FurnaceSpecificComments", "TestLocation", "OvenLocation", "Condition", "PB", "Integral", "Derivative", "Other1", "Other2", "CheckRec", "Load", "LagLimit", "RecoveryLimit"},
