...
![Screenshot of Excel showing the AADSTS700082 expired refresh token authentication error](https://github.com/user-attachments/assets/5d40025c-28fd-4b0b-b138-ece003138fc4)
...
<img width="428" height="629" alt="Excel Data tab menu showing Get Data and Data Source Settings" src="https://github.com/user-attachments/assets/de530887-3745-4566-9b63-e999f014109a" />


2. In the **Data source settings** window, click `Clear All Permissions` then `Delete`, then `Close` the **Data source settings** window.


<img width="802" height="584" alt="Excel Data source settings window with the Clear All Permissions button" src="https://github.com/user-attachments/assets/4c462d82-4683-4c49-8b73-05f6aa224400" />

<img width="462" height="184" alt="Confirmation dialog asking to delete all stored permissions" src="https://github.com/user-attachments/assets/398d35c9-8e1e-4d9c-b4c0-e4041c5e10a2" />


3. Now, go to `Data > Refresh All`.  Excel will automatically prompt you to reauthenticate.


<img width="570" height="167" alt="Excel Data tab showing the Refresh All command" src="https://github.com/user-attachments/assets/5409b9c6-12b6-476b-acdc-20c7dec00935" />
